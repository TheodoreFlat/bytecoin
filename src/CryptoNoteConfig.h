...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xe7; // addresses start with "2"
...
const char     CRYPTONOTE_NAME[]                             = "theflatcoin";
...
const int      P2P_DEFAULT_PORT                              =  23671;
const int      RPC_DEFAULT_PORT                              =  24671;
